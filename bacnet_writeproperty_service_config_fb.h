...
/*! @brief Concrete class representing BACnet WriteProperty service configuration fb
 *
 * WriteProperty Service Configuration FB class. 
 * BACnet WriteProperty Service Configuration FB is a FB that is responible for configuration of 
 * a BACnet WriteProperty server request and a creation of a corresepnding service handle.
 */
