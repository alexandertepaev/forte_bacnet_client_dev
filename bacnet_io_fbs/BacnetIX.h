...
/*! /brief generic class for BacnetIX function blocks providing access to one boolean physical input
 *
 ...
 */
class FORTE_BacnetIX: public CProcessInterface{
  DECLARE_FIRMWARE_FB(FORTE_BacnetIX)
...
public:
  FUNCTION_BLOCK_CTOR_WITH_BASE_CLASS(FORTE_BacnetIX, CProcessInterface){
  };

  virtual ~FORTE_BacnetIX(){};
