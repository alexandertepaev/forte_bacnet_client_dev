...
/*! /brief generic class for BacnetQX function blocks providing access to one boolean physical output
 *
 ...
 */
class FORTE_BacnetQX: public CProcessInterface{
  DECLARE_FIRMWARE_FB(FORTE_BacnetQX)
...
public:
  FUNCTION_BLOCK_CTOR_WITH_BASE_CLASS(FORTE_BacnetQX, CProcessInterface){
  };

  virtual ~FORTE_BacnetQX(){};
