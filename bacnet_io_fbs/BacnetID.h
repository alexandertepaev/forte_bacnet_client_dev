 ...
 */
class FORTE_BacnetID: public CProcessInterface{
  DECLARE_FIRMWARE_FB(FORTE_BacnetID)
...
public:
  FUNCTION_BLOCK_CTOR_WITH_BASE_CLASS(FORTE_BacnetID, CProcessInterface){
  };

  virtual ~FORTE_BacnetID(){};
