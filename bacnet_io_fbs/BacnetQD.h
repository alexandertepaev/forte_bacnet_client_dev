 ...
 */
class FORTE_BacnetQD: public CProcessInterface{
  DECLARE_FIRMWARE_FB(FORTE_BacnetQD)
...
public:
  FUNCTION_BLOCK_CTOR_WITH_BASE_CLASS(FORTE_BacnetQD, CProcessInterface){
  };

  virtual ~FORTE_BacnetQD(){};
